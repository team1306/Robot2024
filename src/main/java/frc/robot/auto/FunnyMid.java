...
public class FunnyMid extends SequentialCommandGroup {
    public FunnyMid(NoteDetector detector, Intake intake, Shooter shooter, Arm arm, DriveTrain driveTrain) {
        ...
        addCommands(
            ...
            AutoCommands.getStartMidToClose2(intake, shooter, arm, driveTrain), //collect close 1 and shoot
