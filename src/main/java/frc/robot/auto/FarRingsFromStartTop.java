...
public class FarRingsFromStartTop extends ParallelCommandGroup {

    public FarRingsFromStartTop(NoteDetector detector, Intake intake, Shooter shooter, Arm arm, DriveTrain driveTrain) {
